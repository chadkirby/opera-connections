 ...
 */ function $b34d8ff0ac521069$var$isArray(value) {
    return !Array.isArray ? $b34d8ff0ac521069$var$getTag(value) === "[object Array]" : Array.isArray(value);
}
// Adapted from: https://github.com/lodash/lodash/blob/master/.internal/baseToString.js
const $b34d8ff0ac521069$var$INFINITY = 1 / 0;
function $b34d8ff0ac521069$var$baseToString(value) {
    // Exit early for strings to avoid a performance hit in some environments.
    if (typeof value == "string") return value;
    let result = value + "";
    return result == "0" && 1 / value == -$b34d8ff0ac521069$var$INFINITY ? "-0" : result;
}
function $b34d8ff0ac521069$var$toString(value) {
    return value == null ? "" : $b34d8ff0ac521069$var$baseToString(value);
}
function $b34d8ff0ac521069$var$isString(value) {
    return typeof value === "string";
}
function $b34d8ff0ac521069$var$isNumber(value) {
    return typeof value === "number";
}
// Adapted from: https://github.com/lodash/lodash/blob/master/isBoolean.js
function $b34d8ff0ac521069$var$isBoolean(value) {
    return value === true || value === false || $b34d8ff0ac521069$var$isObjectLike(value) && $b34d8ff0ac521069$var$getTag(value) == "[object Boolean]";
}
function $b34d8ff0ac521069$var$isObject(value) {
    return typeof value === "object";
}
// Checks if `value` is object-like.
function $b34d8ff0ac521069$var$isObjectLike(value) {
    return $b34d8ff0ac521069$var$isObject(value) && value !== null;
}
function $b34d8ff0ac521069$var$isDefined(value) {
    return value !== undefined && value !== null;
}
function $b34d8ff0ac521069$var$isBlank(value) {
    return !value.trim().length;
}
// Gets the `toStringTag` of `value`.
// Adapted from: https://github.com/lodash/lodash/blob/master/.internal/getTag.js
function $b34d8ff0ac521069$var$getTag(value) {
    return value == null ? value === undefined ? "[object Undefined]" : "[object Null]" : Object.prototype.toString.call(value);
}
const $b34d8ff0ac521069$var$EXTENDED_SEARCH_UNAVAILABLE = "Extended search is not available";
const $b34d8ff0ac521069$var$INCORRECT_INDEX_TYPE = "Incorrect 'index' type";
const $b34d8ff0ac521069$var$LOGICAL_SEARCH_INVALID_QUERY_FOR_KEY = (key)=>`Invalid value for key ${key}`;
const $b34d8ff0ac521069$var$PATTERN_LENGTH_TOO_LARGE = (max)=>`Pattern length exceeds max of ${max}.`;
const $b34d8ff0ac521069$var$MISSING_KEY_PROPERTY = (name)=>`Missing ${name} property in key`;
const $b34d8ff0ac521069$var$INVALID_KEY_WEIGHT_VALUE = (key)=>`Property 'weight' in key '${key}' must be a positive integer`;
const $b34d8ff0ac521069$var$hasOwn = Object.prototype.hasOwnProperty;
class $b34d8ff0ac521069$var$KeyStore {
    get(keyId) {
    ...
    constructor(keys){
        ...
        let totalWeight = 0;
        keys.forEach((key)=>{
            let obj = $b34d8ff0ac521069$var$createKey(key);
...
function $b34d8ff0ac521069$var$createKey(key) {
    let path = null;
    let id = null;
    let src = null;
    let weight = 1;
    let getFn = null;
    if ($b34d8ff0ac521069$var$isString(key) || $b34d8ff0ac521069$var$isArray(key)) {
        src = key;
        path = $b34d8ff0ac521069$var$createKeyPath(key);
        id = $b34d8ff0ac521069$var$createKeyId(key);
    } else {
        if (!$b34d8ff0ac521069$var$hasOwn.call(key, "name")) throw new Error($b34d8ff0ac521069$var$MISSING_KEY_PROPERTY("name"));
        const name = key.name;
        src = name;
        if ($b34d8ff0ac521069$var$hasOwn.call(key, "weight")) {
            weight = key.weight;
            if (weight <= 0) throw new Error($b34d8ff0ac521069$var$INVALID_KEY_WEIGHT_VALUE(name));
        }
        path = $b34d8ff0ac521069$var$createKeyPath(name);
        id = $b34d8ff0ac521069$var$createKeyId(name);
        getFn = key.getFn;
    }
    return {
        path: path,
...
function $b34d8ff0ac521069$var$createKeyPath(key) {
    return $b34d8ff0ac521069$var$isArray(key) ? key : key.split(".");
}
function $b34d8ff0ac521069$var$createKeyId(key) {
    return $b34d8ff0ac521069$var$isArray(key) ? key.join(".") : key;
}
function $b34d8ff0ac521069$var$get(obj1, path1) {
    let list = [];
    let arr = false;
    const deepGet = (obj, path, index)=>{
        if (!$b34d8ff0ac521069$var$isDefined(obj)) return;
        if (!path[index]) // If there's no path left, we've arrived at the object we care about.
        list.push(obj);
        else {
            let key = path[index];
            const value = obj[key];
            if (!$b34d8ff0ac521069$var$isDefined(value)) return;
            // If we're at the last value in the path, and if it's a string/number/bool,
            // add it to the list
            if (index === path.length - 1 && ($b34d8ff0ac521069$var$isString(value) || $b34d8ff0ac521069$var$isNumber(value) || $b34d8ff0ac521069$var$isBoolean(value))) list.push($b34d8ff0ac521069$var$toString(value));
            else if ($b34d8ff0ac521069$var$isArray(value)) {
                arr = true;
    ...
    deepGet(obj1, $b34d8ff0ac521069$var$isString(path1) ? path1.split(".") : path1, 0);
    return arr ? list : list[0];
}
const $b34d8ff0ac521069$var$MatchOptions = {
...
const $b34d8ff0ac521069$var$BasicOptions = {
...
const $b34d8ff0ac521069$var$FuzzyOptions = {
...
const $b34d8ff0ac521069$var$AdvancedOptions = {
    // When `true`, it enables the use of unix-like search commands
    useExtendedSearch: false,
    // The get function to use when fetching an object's properties.
    // The default will search nested paths *ie foo.bar.baz*
    getFn: $b34d8ff0ac521069$var$get,
...
var $b34d8ff0ac521069$var$Config = {
    ...$b34d8ff0ac521069$var$BasicOptions,
    ...$b34d8ff0ac521069$var$MatchOptions,
    ...$b34d8ff0ac521069$var$FuzzyOptions,
    ...$b34d8ff0ac521069$var$AdvancedOptions
};
const $b34d8ff0ac521069$var$SPACE = /[^ ]+/g;
// Field-length norm: the shorter the field, the higher the weight.
// Set to 3 decimals to reduce index size.
function $b34d8ff0ac521069$var$norm(weight = 1, mantissa = 3) {
    const cache = new Map();
    const m = Math.pow(10, mantissa);
    return {
        get (value) {
            const numTokens = value.match($b34d8ff0ac521069$var$SPACE).length;
...
class $b34d8ff0ac521069$var$FuseIndex {
    setSources(docs = []) {
        this.docs = docs;
    }
    ...
    create() {
        ...
        if ($b34d8ff0ac521069$var$isString(this.docs[0])) this.docs.forEach((doc, docIndex)=>{
    ...
    add(doc) {
        const idx = this.size();
        if ($b34d8ff0ac521069$var$isString(doc)) this._addString(doc, idx);
    ...
    _addString(doc, docIndex) {
        if (!$b34d8ff0ac521069$var$isDefined(doc) || $b34d8ff0ac521069$var$isBlank(doc)) return;
        let record = {
            v: doc,
            i: docIndex,
            n: this.norm.get(doc)
    ...
    _addObject(doc, docIndex) {
        ...
        this.keys.forEach((key, keyIndex)=>{
            ...
            if (!$b34d8ff0ac521069$var$isDefined(value)) return;
            if ($b34d8ff0ac521069$var$isArray(value)) {
                let subRecords = [];
                const stack = [
                    {
                        nestedArrIndex: -1,
                ...
                while(stack.length){
                    ...
                    if (!$b34d8ff0ac521069$var$isDefined(value)) continue;
                    if ($b34d8ff0ac521069$var$isString(value) && !$b34d8ff0ac521069$var$isBlank(value)) {
                        let subRecord = {
                            v: value,
                            i: nestedArrIndex,
                    ...
                    } else if ($b34d8ff0ac521069$var$isArray(value)) value.forEach((item, k)=>{
                        stack.push({
                            nestedArrIndex: k,
                            value: item
                        });
            ...
            } else if ($b34d8ff0ac521069$var$isString(value) && !$b34d8ff0ac521069$var$isBlank(value)) {
                let subRecord = {
                    v: value,
                    n: this.norm.get(value)
                };
    ...
    constructor({ getFn: getFn = $b34d8ff0ac521069$var$Config.getFn , fieldNormWeight: fieldNormWeight = $b34d8ff0ac521069$var$Config.fieldNormWeight  } = {}){
        this.norm = $b34d8ff0ac521069$var$norm(fieldNormWeight, 3);
        this.getFn = getFn;
        this.isCreated = false;
        this.setIndexRecords();
    }
}
function $b34d8ff0ac521069$var$createIndex(keys, docs, { getFn: getFn = $b34d8ff0ac521069$var$Config.getFn , fieldNormWeight: fieldNormWeight = $b34d8ff0ac521069$var$Config.fieldNormWeight  } = {}) {
    const myIndex = new $b34d8ff0ac521069$var$FuseIndex({
        getFn: getFn,
        fieldNormWeight: fieldNormWeight
    });
    myIndex.setKeys(keys.map($b34d8ff0ac521069$var$createKey));
    myIndex.setSources(docs);
    myIndex.create();
    return myIndex;
}
function $b34d8ff0ac521069$var$parseIndex(data, { getFn: getFn = $b34d8ff0ac521069$var$Config.getFn , fieldNormWeight: fieldNormWeight = $b34d8ff0ac521069$var$Config.fieldNormWeight  } = {}) {
...
function $b34d8ff0ac521069$var$computeScore$1(pattern, { errors: errors = 0 , currentLocation: currentLocation = 0 , expectedLocation: expectedLocation = 0 , distance: distance = $b34d8ff0ac521069$var$Config.distance , ignoreLocation: ignoreLocation = $b34d8ff0ac521069$var$Config.ignoreLocation  } = {}) {
...
function $b34d8ff0ac521069$var$convertMaskToIndices(matchmask = [], minMatchCharLength = $b34d8ff0ac521069$var$Config.minMatchCharLength) {
    let indices = [];
    let start = -1;
    let end = -1;
    let i = 0;
...
// Machine word size
const $b34d8ff0ac521069$var$MAX_BITS = 32;
function $b34d8ff0ac521069$var$search(text, pattern, patternAlphabet, { location: location = $b34d8ff0ac521069$var$Config.location , distance: distance = $b34d8ff0ac521069$var$Config.distance , threshold: threshold = $b34d8ff0ac521069$var$Config.threshold , findAllMatches: findAllMatches = $b34d8ff0ac521069$var$Config.findAllMatches , minMatchCharLength: minMatchCharLength = $b34d8ff0ac521069$var$Config.minMatchCharLength , includeMatches: includeMatches = $b34d8ff0ac521069$var$Config.includeMatches , ignoreLocation: ignoreLocation = $b34d8ff0ac521069$var$Config.ignoreLocation  } = {}) {
    if (pattern.length > $b34d8ff0ac521069$var$MAX_BITS) throw new Error($b34d8ff0ac521069$var$PATTERN_LENGTH_TOO_LARGE($b34d8ff0ac521069$var$MAX_BITS));
    ...
    while((index = text.indexOf(pattern, bestLocation)) > -1){
        let score = $b34d8ff0ac521069$var$computeScore$1(pattern, {
    ...
    for(let i = 0; i < patternLen; i += 1){
        ...
        let binMid = binMax;
        while(binMin < binMid){
            const score = $b34d8ff0ac521069$var$computeScore$1(pattern, {
                errors: i,
        ...
        for(let j = finish; j >= start; j -= 1){
            ...
            if (bitArr[j] & mask) {
                finalScore = $b34d8ff0ac521069$var$computeScore$1(pattern, {
                    errors: i,
    ...
    if (computeMatches) {
        const indices = $b34d8ff0ac521069$var$convertMaskToIndices(matchMask, minMatchCharLength);
        if (!indices.length) result.isMatch = false;
        else if (includeMatches) result.indices = indices;
    }
    return result;
}
function $b34d8ff0ac521069$var$createPatternAlphabet(pattern) {
    let mask = {};
...
class $b34d8ff0ac521069$var$BitapSearch {
    searchIn(text) {
        ...
        this.chunks.forEach(({ pattern: pattern , alphabet: alphabet , startIndex: startIndex  })=>{
            const { isMatch: isMatch , score: score , indices: indices  } = $b34d8ff0ac521069$var$search(text, pattern, alphabet, {
    ...
    constructor(pattern1, { location: location = $b34d8ff0ac521069$var$Config.location , threshold: threshold = $b34d8ff0ac521069$var$Config.threshold , distance: distance = $b34d8ff0ac521069$var$Config.distance , includeMatches: includeMatches = $b34d8ff0ac521069$var$Config.includeMatches , findAllMatches: findAllMatches = $b34d8ff0ac521069$var$Config.findAllMatches , minMatchCharLength: minMatchCharLength = $b34d8ff0ac521069$var$Config.minMatchCharLength , isCaseSensitive: isCaseSensitive = $b34d8ff0ac521069$var$Config.isCaseSensitive , ignoreLocation: ignoreLocation = $b34d8ff0ac521069$var$Config.ignoreLocation  } = {}){
        this.options = {
            location: location,
            threshold: threshold,
            distance: distance,
        ...
        const addChunk = (pattern, startIndex)=>{
            this.chunks.push({
                pattern: pattern,
                alphabet: $b34d8ff0ac521069$var$createPatternAlphabet(pattern),
                startIndex: startIndex
            });
        };
        const len = this.pattern.length;
        if (len > $b34d8ff0ac521069$var$MAX_BITS) {
            let i = 0;
            const remainder = len % $b34d8ff0ac521069$var$MAX_BITS;
            const end = len - remainder;
            while(i < end){
                addChunk(this.pattern.substr(i, $b34d8ff0ac521069$var$MAX_BITS), i);
                i += $b34d8ff0ac521069$var$MAX_BITS;
            }
            if (remainder) {
                const startIndex = len - $b34d8ff0ac521069$var$MAX_BITS;
                addChunk(this.pattern.substr(startIndex), startIndex);
            }
        } else addChunk(this.pattern, 0);
    }
}
class $b34d8ff0ac521069$var$BaseMatch {
    static isMultiMatch(pattern) {
        return $b34d8ff0ac521069$var$getMatch(pattern, this.multiRegex);
    }
    static isSingleMatch(pattern) {
        return $b34d8ff0ac521069$var$getMatch(pattern, this.singleRegex);
    }
    search() {}
    constructor(pattern){
...
function $b34d8ff0ac521069$var$getMatch(pattern, exp) {
    const matches = pattern.match(exp);
    return matches ? matches[1] : null;
}
// Token: 'file
class $b34d8ff0ac521069$var$ExactMatch extends $b34d8ff0ac521069$var$BaseMatch {
    static get type() {
        return "exact";
    }
...
// Token: !fire
class $b34d8ff0ac521069$var$InverseExactMatch extends $b34d8ff0ac521069$var$BaseMatch {
    static get type() {
...
// Token: ^file
class $b34d8ff0ac521069$var$PrefixExactMatch extends $b34d8ff0ac521069$var$BaseMatch {
    static get type() {
        return "prefix-exact";
    }
    static get multiRegex() {
...
// Token: !^fire
class $b34d8ff0ac521069$var$InversePrefixExactMatch extends $b34d8ff0ac521069$var$BaseMatch {
    static get type() {
...
// Token: .file$
class $b34d8ff0ac521069$var$SuffixExactMatch extends $b34d8ff0ac521069$var$BaseMatch {
    static get type() {
        return "suffix-exact";
    }
    static get multiRegex() {
...
// Token: !.file$
class $b34d8ff0ac521069$var$InverseSuffixExactMatch extends $b34d8ff0ac521069$var$BaseMatch {
    static get type() {
...
class $b34d8ff0ac521069$var$FuzzyMatch extends $b34d8ff0ac521069$var$BaseMatch {
    static get type() {
        return "fuzzy";
    }
    static get multiRegex() {
    ...
    constructor(pattern, { location: location = $b34d8ff0ac521069$var$Config.location , threshold: threshold = $b34d8ff0ac521069$var$Config.threshold , distance: distance = $b34d8ff0ac521069$var$Config.distance , includeMatches: includeMatches = $b34d8ff0ac521069$var$Config.includeMatches , findAllMatches: findAllMatches = $b34d8ff0ac521069$var$Config.findAllMatches , minMatchCharLength: minMatchCharLength = $b34d8ff0ac521069$var$Config.minMatchCharLength , isCaseSensitive: isCaseSensitive = $b34d8ff0ac521069$var$Config.isCaseSensitive , ignoreLocation: ignoreLocation = $b34d8ff0ac521069$var$Config.ignoreLocation  } = {}){
        super(pattern);
        this._bitapSearch = new $b34d8ff0ac521069$var$BitapSearch(pattern, {
            location: location,
            threshold: threshold,
            distance: distance,
            includeMatches: includeMatches,
...
// Token: 'file
class $b34d8ff0ac521069$var$IncludeMatch extends $b34d8ff0ac521069$var$BaseMatch {
    static get type() {
        return "include";
    }
    static get multiRegex() {
...
const $b34d8ff0ac521069$var$searchers = [
    $b34d8ff0ac521069$var$ExactMatch,
    $b34d8ff0ac521069$var$IncludeMatch,
    $b34d8ff0ac521069$var$PrefixExactMatch,
    $b34d8ff0ac521069$var$InversePrefixExactMatch,
    $b34d8ff0ac521069$var$InverseSuffixExactMatch,
    $b34d8ff0ac521069$var$SuffixExactMatch,
    $b34d8ff0ac521069$var$InverseExactMatch,
    $b34d8ff0ac521069$var$FuzzyMatch
];
const $b34d8ff0ac521069$var$searchersLen = $b34d8ff0ac521069$var$searchers.length;
// Regex to split by spaces, but keep anything in quotes together
const $b34d8ff0ac521069$var$SPACE_RE = / +(?=(?:[^\"]*\"[^\"]*\")*[^\"]*$)/;
const $b34d8ff0ac521069$var$OR_TOKEN = "|";
// Return a 2D array representation of the query, for simpler parsing.
// Example:
// "^core go$ | rb$ | py$ xy$" => [["^core", "go$"], ["rb$"], ["py$", "xy$"]]
function $b34d8ff0ac521069$var$parseQuery(pattern, options = {}) {
    return pattern.split($b34d8ff0ac521069$var$OR_TOKEN).map((item1)=>{
        let query = item1.trim().split($b34d8ff0ac521069$var$SPACE_RE).filter((item)=>item && !!item.trim());
        let results = [];
        for(let i = 0, len = query.length; i < len; i += 1){
            ...
            let found = false;
            let idx = -1;
            while(!found && ++idx < $b34d8ff0ac521069$var$searchersLen){
                const searcher = $b34d8ff0ac521069$var$searchers[idx];
            ...
            idx = -1;
            while(++idx < $b34d8ff0ac521069$var$searchersLen){
                const searcher = $b34d8ff0ac521069$var$searchers[idx];
...
// to a singl match
const $b34d8ff0ac521069$var$MultiMatchSet = new Set([
    $b34d8ff0ac521069$var$FuzzyMatch.type,
    $b34d8ff0ac521069$var$IncludeMatch.type
]);
/**
 ...
 * ^core go$ | rb$ | py$
 * ```
 */ class $b34d8ff0ac521069$var$ExtendedSearch {
            ...
            for(let j = 0, pLen = searchers1.length; j < pLen; j += 1){
                ...
                if (isMatch) {
                    ...
                    if (includeMatches) {
                        ...
                        if ($b34d8ff0ac521069$var$MultiMatchSet.has(type)) allIndices = [
                            ...allIndices,
                            ...indices
                        ];
    ...
    constructor(pattern, { isCaseSensitive: isCaseSensitive = $b34d8ff0ac521069$var$Config.isCaseSensitive , includeMatches: includeMatches = $b34d8ff0ac521069$var$Config.includeMatches , minMatchCharLength: minMatchCharLength = $b34d8ff0ac521069$var$Config.minMatchCharLength , ignoreLocation: ignoreLocation = $b34d8ff0ac521069$var$Config.ignoreLocation , findAllMatches: findAllMatches = $b34d8ff0ac521069$var$Config.findAllMatches , location: location = $b34d8ff0ac521069$var$Config.location , threshold: threshold = $b34d8ff0ac521069$var$Config.threshold , distance: distance = $b34d8ff0ac521069$var$Config.distance  } = {}){
        this.query = null;
        this.options = {
            isCaseSensitive: isCaseSensitive,
            includeMatches: includeMatches,
        ...
        this.query = $b34d8ff0ac521069$var$parseQuery(this.pattern, this.options);
    }
}
const $b34d8ff0ac521069$var$registeredSearchers = [];
function $b34d8ff0ac521069$var$register(...args) {
    $b34d8ff0ac521069$var$registeredSearchers.push(...args);
}
function $b34d8ff0ac521069$var$createSearcher(pattern, options) {
    for(let i = 0, len = $b34d8ff0ac521069$var$registeredSearchers.length; i < len; i += 1){
        let searcherClass = $b34d8ff0ac521069$var$registeredSearchers[i];
        if (searcherClass.condition(pattern, options)) return new searcherClass(pattern, options);
    }
    return new $b34d8ff0ac521069$var$BitapSearch(pattern, options);
}
const $b34d8ff0ac521069$var$LogicalOperator = {
    AND: "$and",
    OR: "$or"
};
const $b34d8ff0ac521069$var$KeyType = {
    PATH: "$path",
    PATTERN: "$val"
};
const $b34d8ff0ac521069$var$isExpression = (query)=>!!(query[$b34d8ff0ac521069$var$LogicalOperator.AND] || query[$b34d8ff0ac521069$var$LogicalOperator.OR]);
const $b34d8ff0ac521069$var$isPath = (query)=>!!query[$b34d8ff0ac521069$var$KeyType.PATH];
const $b34d8ff0ac521069$var$isLeaf = (query)=>!$b34d8ff0ac521069$var$isArray(query) && $b34d8ff0ac521069$var$isObject(query) && !$b34d8ff0ac521069$var$isExpression(query);
const $b34d8ff0ac521069$var$convertToExplicit = (query)=>({
        [$b34d8ff0ac521069$var$LogicalOperator.AND]: Object.keys(query).map((key)=>({
                [key]: query[key]
            }))
    });
// When `auto` is `true`, the parse function will infer and initialize and add
// the appropriate `Searcher` instance
function $b34d8ff0ac521069$var$parse(query1, options, { auto: auto = true  } = {}) {
    const next = (query)=>{
        let keys = Object.keys(query);
        const isQueryPath = $b34d8ff0ac521069$var$isPath(query);
        if (!isQueryPath && keys.length > 1 && !$b34d8ff0ac521069$var$isExpression(query)) return next($b34d8ff0ac521069$var$convertToExplicit(query));
        if ($b34d8ff0ac521069$var$isLeaf(query)) {
            const key = isQueryPath ? query[$b34d8ff0ac521069$var$KeyType.PATH] : keys[0];
            const pattern = isQueryPath ? query[$b34d8ff0ac521069$var$KeyType.PATTERN] : query[key];
            if (!$b34d8ff0ac521069$var$isString(pattern)) throw new Error($b34d8ff0ac521069$var$LOGICAL_SEARCH_INVALID_QUERY_FOR_KEY(key));
            const obj = {
                keyId: $b34d8ff0ac521069$var$createKeyId(key),
                pattern: pattern
            };
            if (auto) obj.searcher = $b34d8ff0ac521069$var$createSearcher(pattern, options);
            return obj;
        }
        let node = {
            children: [],
        ...
        keys.forEach((key)=>{
            ...
            if ($b34d8ff0ac521069$var$isArray(value)) value.forEach((item)=>{
                node.children.push(next(item));
            });
        });
        return node;
    };
    if (!$b34d8ff0ac521069$var$isExpression(query1)) query1 = $b34d8ff0ac521069$var$convertToExplicit(query1);
    return next(query1);
}
// Practical scoring function
function $b34d8ff0ac521069$var$computeScore(results, { ignoreFieldNorm: ignoreFieldNorm = $b34d8ff0ac521069$var$Config.ignoreFieldNorm  }) {
...
function $b34d8ff0ac521069$var$transformMatches(result, data) {
    const matches = result.matches;
    data.matches = [];
    if (!$b34d8ff0ac521069$var$isDefined(matches)) return;
    matches.forEach((match)=>{
        if (!$b34d8ff0ac521069$var$isDefined(match.indices) || !match.indices.length) return;
...
function $b34d8ff0ac521069$var$transformScore(result, data) {
    data.score = result.score;
}
function $b34d8ff0ac521069$var$format(results, docs, { includeMatches: includeMatches = $b34d8ff0ac521069$var$Config.includeMatches , includeScore: includeScore = $b34d8ff0ac521069$var$Config.includeScore  } = {}) {
    const transformers = [];
    if (includeMatches) transformers.push($b34d8ff0ac521069$var$transformMatches);
    if (includeScore) transformers.push($b34d8ff0ac521069$var$transformScore);
...
class $b34d8ff0ac521069$export$2e2bcd8739ae039 {
    setCollection(docs, index) {
        this._docs = docs;
        if (index && !(index instanceof $b34d8ff0ac521069$var$FuseIndex)) throw new Error($b34d8ff0ac521069$var$INCORRECT_INDEX_TYPE);
        this._myIndex = index || $b34d8ff0ac521069$var$createIndex(this.options.keys, this._docs, {
            getFn: this.options.getFn,
            fieldNormWeight: this.options.fieldNormWeight
        });
    }
    add(doc) {
        if (!$b34d8ff0ac521069$var$isDefined(doc)) return;
        this._docs.push(doc);
    ...
    search(query, { limit: limit = -1  } = {}) {
        ...
        let results = $b34d8ff0ac521069$var$isString(query) ? $b34d8ff0ac521069$var$isString(this._docs[0]) ? this._searchStringList(query) : this._searchObjectList(query) : this._searchLogical(query);
        $b34d8ff0ac521069$var$computeScore(results, {
            ignoreFieldNorm: ignoreFieldNorm
        });
        if (shouldSort) results.sort(sortFn);
        if ($b34d8ff0ac521069$var$isNumber(limit) && limit > -1) results = results.slice(0, limit);
        return $b34d8ff0ac521069$var$format(results, this._docs, {
            includeMatches: includeMatches,
            includeScore: includeScore
        });
    }
    _searchStringList(query) {
        const searcher = $b34d8ff0ac521069$var$createSearcher(query, this.options);
        const { records: records  } = this._myIndex;
        const results = [];
        // Iterate over every string in the index
        records.forEach(({ v: text , i: idx , n: norm3  })=>{
            if (!$b34d8ff0ac521069$var$isDefined(text)) return;
    ...
    _searchLogical(query) {
        const expression = $b34d8ff0ac521069$var$parse(query, this.options);
        const evaluate = (node, item, idx)=>{
            ...
            for(let i = 0, len = node.children.length; i < len; i += 1){
                ...
                else if (node.operator === $b34d8ff0ac521069$var$LogicalOperator.AND) return [];
            }
            return res;
        };
        ...
        records.forEach(({ $: item , i: idx  })=>{
            if ($b34d8ff0ac521069$var$isDefined(item)) {
    ...
    _searchObjectList(query) {
        ...
        records.forEach(({ $: item , i: idx  })=>{
            if (!$b34d8ff0ac521069$var$isDefined(item)) return;
            let matches = [];
            // Iterate over every key (i.e, path), and fetch the value at that key
    ...
    _findMatches({ key: key , value: value , searcher: searcher  }) {
        if (!$b34d8ff0ac521069$var$isDefined(value)) return [];
        let matches = [];
        if ($b34d8ff0ac521069$var$isArray(value)) value.forEach(({ v: text , i: idx , n: norm4  })=>{
            if (!$b34d8ff0ac521069$var$isDefined(text)) return;
            const { isMatch: isMatch , score: score , indices: indices  } = searcher.searchIn(text);
    ...
    constructor(docs, options = {}, index){
        this.options = {
            ...$b34d8ff0ac521069$var$Config,
            ...options
        };
        this.options.useExtendedSearch;
        this._keyStore = new $b34d8ff0ac521069$var$KeyStore(this.options.keys);
        this.setCollection(docs, index);
    }
}
$b34d8ff0ac521069$export$2e2bcd8739ae039.version = "6.6.2";
$b34d8ff0ac521069$export$2e2bcd8739ae039.createIndex = $b34d8ff0ac521069$var$createIndex;
$b34d8ff0ac521069$export$2e2bcd8739ae039.parseIndex = $b34d8ff0ac521069$var$parseIndex;
$b34d8ff0ac521069$export$2e2bcd8739ae039.config = $b34d8ff0ac521069$var$Config;
$b34d8ff0ac521069$export$2e2bcd8739ae039.parseQuery = $b34d8ff0ac521069$var$parse;
$b34d8ff0ac521069$var$register($b34d8ff0ac521069$var$ExtendedSearch);


var $2033eefae501e64d$export$1e511d4a378977f5;
var $2033eefae501e64d$export$9f17032d917177de;
var $2033eefae501e64d$export$ff7f7c97cdce86e;
"use strict";
$2033eefae501e64d$export$1e511d4a378977f5 = true;
$2033eefae501e64d$export$9f17032d917177de = $2033eefae501e64d$export$ff7f7c97cdce86e = void 0;
var $2033eefae501e64d$var$peq = new Uint32Array(0x10000);
var $2033eefae501e64d$var$myers_32 = function(a, b) {
    var n = a.length;
    var m = b.length;
    var lst = 1 << n - 1;
    var pv = -1;
    ...
    var sc = n;
    var i = n;
    while(i--)$2033eefae501e64d$var$peq[a.charCodeAt(i)] |= 1 << i;
    for(i = 0; i < m; i++){
        var eq = $2033eefae501e64d$var$peq[b.charCodeAt(i)];
        var xv = eq | mv;
        eq |= (eq & pv) + pv ^ pv;
        mv |= ~(eq | pv);
        pv &= eq;
    ...
    i = n;
    while(i--)$2033eefae501e64d$var$peq[a.charCodeAt(i)] = 0;
    return sc;
};
var $2033eefae501e64d$var$myers_x = function(b, a) {
    var n = a.length;
    var m = b.length;
    var mhc = [];
    var phc = [];
    ...
    for(; j < vsize - 1; j++){
        ...
        for(var k = start_1; k < vlen_1; k++)$2033eefae501e64d$var$peq[b.charCodeAt(k)] |= 1 << k;
        for(var i = 0; i < n; i++){
            var eq = $2033eefae501e64d$var$peq[a.charCodeAt(i)];
        ...
        for(var k = start_1; k < vlen_1; k++)$2033eefae501e64d$var$peq[b.charCodeAt(k)] = 0;
    }
    var mv = 0;
    var pv = -1;
    var start = j * 32;
    var vlen = Math.min(32, m - start) + start;
    for(var k = start; k < vlen; k++)$2033eefae501e64d$var$peq[b.charCodeAt(k)] |= 1 << k;
    var score = m;
    for(var i = 0; i < n; i++){
        var eq = $2033eefae501e64d$var$peq[a.charCodeAt(i)];
        var pb = phc[i / 32 | 0] >>> i & 1;
    ...
    for(var k = start; k < vlen; k++)$2033eefae501e64d$var$peq[b.charCodeAt(k)] = 0;
    return score;
};
var $2033eefae501e64d$var$distance = function(a, b) {
    ...
    if (a.length <= 32) return $2033eefae501e64d$var$myers_32(a, b);
    return $2033eefae501e64d$var$myers_x(a, b);
};
$2033eefae501e64d$export$9f17032d917177de = $2033eefae501e64d$var$distance;
var $2033eefae501e64d$var$closest = function(str, arr) {
    var min_distance = Infinity;
    var min_index = 0;
    for(var i = 0; i < arr.length; i++){
        var dist = $2033eefae501e64d$var$distance(str, arr[i]);
...
$2033eefae501e64d$export$ff7f7c97cdce86e = $2033eefae501e64d$var$closest;


var $4d491d7d54df076b$export$2e2bcd8739ae039 = [
    {
    ...
    },
    {
        ...
        ...opera,
        normalized: $4d491d7d54df076b$export$a3295358bff77e(opera.title)
    }));
function $4d491d7d54df076b$export$a3295358bff77e(str) {
    return str.normalize("NFD").replace(/[\u0300-\u036f]/g, "").replace(/\s/g, " ").replace(/[^\w\s]/g, "_").trim();
}


const $9d51343fa3eac4bf$var$fuse = new (0, $b34d8ff0ac521069$export$2e2bcd8739ae039)((0, $4d491d7d54df076b$export$2e2bcd8739ae039), {
    keys: [
        "normalized",
        "Translation",
        "alternate",
...
const $9d51343fa3eac4bf$var$targetOpera = (0, $4d491d7d54df076b$export$2e2bcd8739ae039)[Math.floor(Math.random() * (0, $4d491d7d54df076b$export$2e2bcd8739ae039).length)];
const $9d51343fa3eac4bf$var$inputEl = document.getElementById("opera-input");
const $9d51343fa3eac4bf$var$guessButton = document.getElementById("guess-button");
const $9d51343fa3eac4bf$var$selectedOperaEl = $9d51343fa3eac4bf$var$guessButton; // document.getElementById("selected-opera")!;
const $9d51343fa3eac4bf$var$scoreTemplate = document.getElementById("score-template");
function $9d51343fa3eac4bf$var$doGuess() {
    let guessedOpera = (0, $4d491d7d54df076b$export$2e2bcd8739ae039)[parseInt($9d51343fa3eac4bf$var$selectedOperaEl.dataset.refIndex)];
    let scoreRow = $9d51343fa3eac4bf$var$scoreTemplate.content.cloneNode(true);
    scoreRow.querySelector("h2").textContent = $9d51343fa3eac4bf$var$selectedOperaEl.textContent;
    let composerDist = (0, $2033eefae501e64d$export$9f17032d917177de)((0, $4d491d7d54df076b$export$a3295358bff77e)($9d51343fa3eac4bf$var$targetOpera.composer), (0, $4d491d7d54df076b$export$a3295358bff77e)(guessedOpera.Composer));
    scoreRow.querySelector(".composer-score").textContent = composerDist.toString();
    document.body.appendChild(scoreRow);
    $9d51343fa3eac4bf$var$inputEl.value = "";
    $9d51343fa3eac4bf$var$fuse.removeAt(Number($9d51343fa3eac4bf$var$selectedOperaEl.dataset.refIndex));
    $9d51343fa3eac4bf$var$disableGuessBtn();
}
$9d51343fa3eac4bf$var$guessButton.onclick = $9d51343fa3eac4bf$var$doGuess;
$9d51343fa3eac4bf$var$inputEl.oninput = ()=>{
    $9d51343fa3eac4bf$var$selectedOperaEl.textContent = "";
    let input = $9d51343fa3eac4bf$var$inputEl.value;
    let [suggestion] = $9d51343fa3eac4bf$var$fuse.search((0, $4d491d7d54df076b$export$a3295358bff77e)(input), {
        limit: 1
    });
    if (suggestion) {
        $9d51343fa3eac4bf$var$guessButton.removeAttribute("disabled");
        let [{ indices: [indices] , key: key , value: value  }] = suggestion.matches;
        $9d51343fa3eac4bf$var$selectedOperaEl.dataset.refIndex = suggestion.refIndex.toString();
        if (key === "normalized") {
            let [before, match, after] = $9d51343fa3eac4bf$var$split(suggestion.item.title || "", indices);
            $9d51343fa3eac4bf$var$selectedOperaEl.appendChild(document.createTextNode(before));
            let strong = document.createElement("strong");
            strong.textContent = match;
            $9d51343fa3eac4bf$var$selectedOperaEl.appendChild(strong);
            $9d51343fa3eac4bf$var$selectedOperaEl.appendChild(document.createTextNode(after));
        } else $9d51343fa3eac4bf$var$selectedOperaEl.textContent = suggestion.item.title;
    } else $9d51343fa3eac4bf$var$disableGuessBtn();
};
function $9d51343fa3eac4bf$var$disableGuessBtn() {
    $9d51343fa3eac4bf$var$selectedOperaEl.textContent = "Unknown opera";
    $9d51343fa3eac4bf$var$guessButton.setAttribute("disabled", "disabled");
}
$9d51343fa3eac4bf$var$inputEl.onkeydown = (e)=>{
    if (e.key === "Enter") $9d51343fa3eac4bf$var$doGuess();
};
function $9d51343fa3eac4bf$var$split(title, indices) {
    let curr = 0;
    let result = [];
...
//# sourceMappingURL=index.5dd697b9.js.map
